                                ...
                                <div class="portlet box red">
									<div class="portlet-title">
										<div class="caption">
                                            ...
                                            <?php
                                                echo "'s Screenshots"; //$users_photos_xml
                                            ?></div>
								    ...
								    <div class="portlet-body">
                                        ...
                                        <div class="row">
                                            <?php 
                                            $rows = sql($DBH,"SELECT * FROM tbl_screenshot where employee_id =  ? order by (date_time) desc",array($SESS_DEVICE_ID),"rows");
                                            foreach($rows as $row){ ?>
                                                <div class="col-md-3 hvr">
                                                    <img class="screenshot" src="<?php echo $row['image']; ?>" alt="" />
                                                    <p class="my-placeholder"><?php echo my_simple_date($row['date_time']); ?></p>
                                                </div>
                                            <?php } ?>
                                        </div>

...
?>
                                ...
                                <div class="portlet-body">
                                    <div class="row">
                                            ...
                                            <ul style="border: none;" class="nav nav-tabs tabs-left">
                                                ...
                                                <li>
                                                    <a href="#tab_documents" data-toggle="tab"><i class="fa fa-folder-open-o"></i> Documents
                                                      <?php if(count($employee_documents) > 0){echo "<span class='badge badge-info pull-right'>".count($employee_documents)."</span>";} ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#tab_assets" data-toggle="tab"><i class="fa fa-tags"></i> Assets
                                                      <?php if($total_assets_given > 0){echo "<span class='badge badge-info pull-right'>Given: ".$total_assets_given."</span>";} ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#tab_time_off" data-toggle="tab"><i class="fa fa-clock-o"></i> Time Off
                                                      <?php if($pending_leave_count>0){echo "<span class='badge badge-info pull-right'>Pending: ".$pending_leave_count."</span>";} ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#tab_compensation" data-toggle="tab"><i class="fa fa-money"></i> Compensation
                                                      <?php if($compensation_count>0){echo "<span class='badge badge-info pull-right'>".ucfirst(date("M")).": $".$compensation_count."</span>";} ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#tab_advance_salary" data-toggle="tab"><i class="fa fa-money"></i> Advance Salary
                                                      <?php if($advance_salary_count>0){echo "<span class='badge badge-info pull-right'>".ucfirst(date("M")).": $".$advance_salary_count."</span>";} ?>
                                                    </a>
                                                </li>
                                                 <li>
                                                    <a href="#tab_expense" data-toggle="tab"><i class="fa fa-money"></i>  Expense
                                                      <?php if($expense_total>0){echo "<span class='badge badge-info pull-right'>$".$expense_total."</span>";} ?>
                                                    </a>
                                                </li>
                                                <li>
                                        ...
                                        <div class="row">
                                            ...
                                            <label>Date of birth: </label> <!-- .date-picker -->
                                                ...
                                                <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                                    <input name="dob" type="text" class="form-control" value="<?php echo date("d-m-Y",$employee_login['dob']); ?>" readonly>
                                                    <span class="input-group-btn">
                                                        <button class="btn default" style="padding: 9px;" type="button">
                                        ...
                                        */
                                        ...
                                        $tbl_screenshot = sql($DBH,"SELECT * FROM tbl_screenshot where employee_id = ? and date_time >= ? and date_time <= ? order by (date_time) desc",
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                ...
                                                <form action="" class="form-horizontal filter_form2" method="GET">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="input-group input-large date-picker input-daterange" data-date-format="yyyy-mm-dd">
                                                            <input type="text" class="form-control" value="<?php echo $date_from; ?>" name="date_from2" readonly="" />
                                                            <span class="input-group-addon"> to </span>
                                                            <input type="text" class="form-control" value="<?php echo $date_to; ?>" name="date_to2" readonly="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <button type="submit" class="btn yellow"><i class="fa fa-filter"></i> <?php echo $filter_xml; ?></button>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                ...
                                                <form action="" class="form-horizontal filter_form3" method="GET">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="input-group input-large date-picker input-daterange" data-date-format="yyyy-mm-dd">
                                                            <input type="text" class="form-control" value="<?php echo $date_from; ?>" name="date_from3" readonly="" />
                                                            <span class="input-group-addon"> to </span>
                                                            <input type="text" class="form-control" value="<?php echo $date_to; ?>" name="date_to3" readonly="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <button type="submit" class="btn yellow"><i class="fa fa-filter"></i> <?php echo $filter_xml; ?></button>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                ...
                                                <form action="" class="form-horizontal filter_form1" method="GET">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="input-group input-large date-picker input-daterange" data-date-format="yyyy-mm-dd">
                                                            <input type="text" class="form-control" value="<?php echo $date_from; ?>" name="date_from1" readonly="" />
                                                            <span class="input-group-addon"> to </span>
                                                            <input type="text" class="form-control" value="<?php echo $date_to; ?>" name="date_to1" readonly="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <button type="submit" class="btn yellow"><i class="fa fa-filter"></i> <?php echo $filter_xml; ?></button>
                                  ...
                                  <div class="form-group">
                                      <label>Date Given: <small>(leave empty for current date & time)</small></label>
                                       ...
                                       <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                                            <input name="txt_assets_given_date" type="text" class="form-control" value="<?php echo $date_to; ?>" readonly>
                                            <span class="input-group-btn">
                                                <button class="btn default" style="padding: 9px;" type="button">
                                                    <i class="fa fa-calendar"></i>
                                                </button>
            ...
            <div id="view_expense" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  <div class="modal-header">
                  <h4 class="modal-title">
                    <span>Expense Receipt</span>
                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal" aria-hidden="true">
                    <i class="fa fa-times"></i>
                    </button>
                  </h4>
                  </div>
                  <div class="modal-body">
                    <img src="" alt="" style="display:block; margin:0 auto;" class="view_expense" />
                  </div>
                </div>
              </div>
            </div>
            ...
            function initMap() {
                ...
                my_polygons 	= $.parseJSON(my_polygons);
                 ...
                 $(".attachment").click(function(){
                   ...
                   $("#view_expense").modal("show");
                   $("#view_expense .modal-title span").html("Expense Receipt <b>"+title+"</b>");
                   $(".view_expense").attr("src",src);
                   $(".view_expense").height((window.innerHeight-125)+"px");
                 });




                 //class="attachment" href="javascript:;" data-toggle="popover" title="<?php echo $title; ?>" data-img="<?php echo $attachment; ?>"
